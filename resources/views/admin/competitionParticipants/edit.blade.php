    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.competition-participants.update", [$competitionParticipant->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\CompetitionParticipant::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $competitionParticipant->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fig_licence_nr') ? 'is-invalid' : '' }}" type="text" name="fig_licence_nr" id="fig_licence_nr" value="{{ old('fig_licence_nr', $competitionParticipant->fig_licence_nr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('national_lic') ? 'is-invalid' : '' }}" type="text" name="national_lic" id="national_lic" value="{{ old('national_lic', $competitionParticipant->national_lic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_birth') ? 'is-invalid' : '' }}" type="text" name="year_of_birth" id="year_of_birth" value="{{ old('year_of_birth', $competitionParticipant->year_of_birth) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coaches') ? 'is-invalid' : '' }}" type="text" name="coaches" id="coaches" value="{{ old('coaches', $competitionParticipant->coaches) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('age_group') ? 'is-invalid' : '' }}" name="age_group" id="age_group">
                    ...
                    @foreach(App\Models\CompetitionParticipant::AGE_GROUP_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('age_group', $competitionParticipant->age_group) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $competitionParticipant->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $competitionParticipant->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_address') ? 'is-invalid' : '' }}" type="text" name="contact_address" id="contact_address" value="{{ old('contact_address', $competitionParticipant->contact_address) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category_id" id="category_id">
                    @foreach($categories as $id => $entry)
                        <option value="{{ $id }}" {{ (old('category_id') ? old('category_id') : $competitionParticipant->category->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('max_checkboxes') ? 'is-invalid' : '' }}" name="max_checkboxes" id="max_checkboxes">
                    ...
                    @foreach(App\Models\CompetitionParticipant::MAX_CHECKBOXES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('max_checkboxes', $competitionParticipant->max_checkboxes) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_wa') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_wa" id="apparatus_wa" value="1" {{ $competitionParticipant->apparatus_wa || old('apparatus_wa', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_rope') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_rope" id="apparatus_rope" value="1" {{ $competitionParticipant->apparatus_rope || old('apparatus_rope', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_hoop') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_hoop" id="apparatus_hoop" value="1" {{ $competitionParticipant->apparatus_hoop || old('apparatus_hoop', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_ball') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_ball" id="apparatus_ball" value="1" {{ $competitionParticipant->apparatus_ball || old('apparatus_ball', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_clubs') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_clubs" id="apparatus_clubs" value="1" {{ $competitionParticipant->apparatus_clubs || old('apparatus_clubs', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apparatus_ribbon') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apparatus_ribbon" id="apparatus_ribbon" value="1" {{ $competitionParticipant->apparatus_ribbon || old('apparatus_ribbon', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_wa_logo') ? 'is-invalid' : '' }}" type="text" name="apparatus_wa_logo" id="apparatus_wa_logo" value="{{ old('apparatus_wa_logo', $competitionParticipant->apparatus_wa_logo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_rope_foto') ? 'is-invalid' : '' }}" type="text" name="apparatus_rope_foto" id="apparatus_rope_foto" value="{{ old('apparatus_rope_foto', $competitionParticipant->apparatus_rope_foto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_hoop_foto') ? 'is-invalid' : '' }}" type="text" name="apparatus_hoop_foto" id="apparatus_hoop_foto" value="{{ old('apparatus_hoop_foto', $competitionParticipant->apparatus_hoop_foto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_ball_foto') ? 'is-invalid' : '' }}" type="text" name="apparatus_ball_foto" id="apparatus_ball_foto" value="{{ old('apparatus_ball_foto', $competitionParticipant->apparatus_ball_foto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_clubs_foto') ? 'is-invalid' : '' }}" type="text" name="apparatus_clubs_foto" id="apparatus_clubs_foto" value="{{ old('apparatus_clubs_foto', $competitionParticipant->apparatus_clubs_foto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apparatus_ribbon_foto') ? 'is-invalid' : '' }}" type="text" name="apparatus_ribbon_foto" id="apparatus_ribbon_foto" value="{{ old('apparatus_ribbon_foto', $competitionParticipant->apparatus_ribbon_foto) }}">
