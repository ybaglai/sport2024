...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ivent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ivents.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('virtual') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="virtual" id="virtual" value="1" {{ old('virtual', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('deadline_d_form_and_mp_3') ? 'is-invalid' : '' }}" type="text" name="deadline_d_form_and_mp_3" id="deadline_d_form_and_mp_3" value="{{ old('deadline_d_form_and_mp_3') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('contact') ? 'is-invalid' : '' }}" name="contact" id="contact">{!! old('contact') !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('allow_volunteers_registration') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="allow_volunteers_registration" id="allow_volunteers_registration" value="1" {{ old('allow_volunteers_registration', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('volunteers_from') ? 'is-invalid' : '' }}" type="text" name="volunteers_from" id="volunteers_from" value="{{ old('volunteers_from') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('volunteers_to') ? 'is-invalid' : '' }}" type="text" name="volunteers_to" id="volunteers_to" value="{{ old('volunteers_to') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('allow_meal_form') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="allow_meal_form" id="allow_meal_form" value="1" {{ old('allow_meal_form', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meal_from') ? 'is-invalid' : '' }}" type="text" name="meal_from" id="meal_from" value="{{ old('meal_from', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('meal_to') ? 'is-invalid' : '' }}" type="text" name="meal_to" id="meal_to" value="{{ old('meal_to') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('media_registration') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="media_registration" id="media_registration" value="1" {{ old('media_registration', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('travel_form') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="travel_form" id="travel_form" value="1" {{ old('travel_form', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hotel_form') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hotel_form" id="hotel_form" value="1" {{ old('hotel_form', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('visa_form') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="visa_form" id="visa_form" value="1" {{ old('visa_form', 0) == 1 ? 'checked' : '' }}>
