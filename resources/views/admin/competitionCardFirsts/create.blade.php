...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.competitionCardFirst.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.competition-card-firsts.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('competition_participiant') ? 'is-invalid' : '' }}" name="competition_participiant_id" id="competition_participiant_id">
                    @foreach($competition_participiants as $id => $entry)
                        <option value="{{ $id }}" {{ old('competition_participiant_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('competition_group') ? 'is-invalid' : '' }}" name="competition_group_id" id="competition_group_id">
                    @foreach($competition_groups as $id => $entry)
                        <option value="{{ $id }}" {{ old('competition_group_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('year_category') ? 'is-invalid' : '' }}" name="year_category_id" id="year_category_id">
                    @foreach($year_categories as $id => $entry)
                        <option value="{{ $id }}" {{ old('year_category_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db_1') ? 'is-invalid' : '' }}" type="number" name="db_1" id="db_1" value="{{ old('db_1', '0') }}" step="0.001">
                @if($errors->has('db_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('db_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db_2') ? 'is-invalid' : '' }}" type="number" name="db_2" id="db_2" value="{{ old('db_2', '0') }}" step="0.001">
                @if($errors->has('db_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('db_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db_3') ? 'is-invalid' : '' }}" type="number" name="db_3" id="db_3" value="{{ old('db_3', '0') }}" step="0.001">
                @if($errors->has('db_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('db_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db_4') ? 'is-invalid' : '' }}" type="number" name="db_4" id="db_4" value="{{ old('db_4', '0') }}" step="0.001">
                @if($errors->has('db_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('db_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db') ? 'is-invalid' : '' }}" type="number" name="db" id="db" value="{{ old('db', '0') }}" step="0.001">
                @if($errors->has('db'))
                    <div class="invalid-feedback">
                        {{ $errors->first('db') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da_1') ? 'is-invalid' : '' }}" type="number" name="da_1" id="da_1" value="{{ old('da_1', '0') }}" step="0.001">
                @if($errors->has('da_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('da_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da_2') ? 'is-invalid' : '' }}" type="number" name="da_2" id="da_2" value="{{ old('da_2', '0') }}" step="0.001">
                @if($errors->has('da_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('da_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da_3') ? 'is-invalid' : '' }}" type="number" name="da_3" id="da_3" value="{{ old('da_3', '0') }}" step="0.001">
                @if($errors->has('da_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('da_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da_4') ? 'is-invalid' : '' }}" type="number" name="da_4" id="da_4" value="{{ old('da_4', '0') }}" step="0.001">
                @if($errors->has('da_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('da_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ded') ? 'is-invalid' : '' }}" type="number" name="ded" id="ded" value="{{ old('ded', '0') }}" step="0.001">
                @if($errors->has('ded'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ded') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da') ? 'is-invalid' : '' }}" type="number" name="da" id="da" value="{{ old('da', '0') }}" step="0.001">
                @if($errors->has('da'))
                    <div class="invalid-feedback">
                        {{ $errors->first('da') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a_1') ? 'is-invalid' : '' }}" type="number" name="a_1" id="a_1" value="{{ old('a_1', '0') }}" step="0.001">
                @if($errors->has('a_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('a_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a_2') ? 'is-invalid' : '' }}" type="number" name="a_2" id="a_2" value="{{ old('a_2', '0') }}" step="0.001">
                @if($errors->has('a_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('a_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a_4') ? 'is-invalid' : '' }}" type="number" name="a_4" id="a_4" value="{{ old('a_4', '0') }}" step="0.001">
                @if($errors->has('a_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('a_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a_3') ? 'is-invalid' : '' }}" type="number" name="a_3" id="a_3" value="{{ old('a_3', '0') }}" step="0.001">
                @if($errors->has('a_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('a_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a') ? 'is-invalid' : '' }}" type="number" name="a" id="a" value="{{ old('a', '0') }}" step="0.001">
                @if($errors->has('a'))
                    <div class="invalid-feedback">
                        {{ $errors->first('a') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_1') ? 'is-invalid' : '' }}" type="number" name="e_1" id="e_1" value="{{ old('e_1', '0') }}" step="0.001">
                @if($errors->has('e_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('e_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_2') ? 'is-invalid' : '' }}" type="number" name="e_2" id="e_2" value="{{ old('e_2', '0') }}" step="0.001">
                @if($errors->has('e_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('e_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_3') ? 'is-invalid' : '' }}" type="number" name="e_3" id="e_3" value="{{ old('e_3', '0') }}" step="0.001">
                @if($errors->has('e_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('e_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_4') ? 'is-invalid' : '' }}" type="number" name="e_4" id="e_4" value="{{ old('e_4', '0') }}" step="0.001">
                @if($errors->has('e_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('e_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e') ? 'is-invalid' : '' }}" type="number" name="e" id="e" value="{{ old('e', '0') }}" step="0.001">
                @if($errors->has('e'))
                    <div class="invalid-feedback">
                        {{ $errors->first('e') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('db_plus_da') ? 'is-invalid' : '' }}" type="number" name="db_plus_da" id="db_plus_da" value="{{ old('db_plus_da', '0') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('a_panel') ? 'is-invalid' : '' }}" type="number" name="a_panel" id="a_panel" value="{{ old('a_panel', '0') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_panel') ? 'is-invalid' : '' }}" type="number" name="e_panel" id="e_panel" value="{{ old('e_panel', '0') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('overall_score') ? 'is-invalid' : '' }}" type="number" name="overall_score" id="overall_score" value="{{ old('overall_score', '0') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place') ? 'is-invalid' : '' }}" type="number" name="place" id="place" value="{{ old('place', '0') }}" step="1">
                @if($errors->has('place'))
                    <div class="invalid-feedback">
                        {{ $errors->first('place') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('evaluated') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="evaluated" id="evaluated" value="1" {{ old('evaluated', 0) == 1 ? 'checked' : '' }}>
