...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-countrieCompetitionParticipants">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.competitionParticipant.fields.countrie') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($competitionParticipants as $key => $competitionParticipant)
                        <tr data-entry-id="{{ $competitionParticipant->id }}">
                            ...
                            <td>
                                {{ $competitionParticipant->countrie->name ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-countrieCompetitionParticipants:not(.ajaxTable)').DataTable({ buttons: dtButtons })
